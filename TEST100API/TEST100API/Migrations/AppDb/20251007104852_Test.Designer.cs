...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TEST100API.Models.Entities.ShippingTransfer", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ShippingTransferID"));
            ...
            modelBuilder.Entity("TEST100API.Models.Entities.ShippingTransfer", b =>
                {
                    b.HasOne("TEST100API.Models.Entities.Order", "Order")
                        .WithOne("ShippingTransfer")
                        .HasForeignKey("TEST100API.Models.Entities.ShippingTransfer", "OrderID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
